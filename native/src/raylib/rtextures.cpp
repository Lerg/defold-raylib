...
#define STBI_NO_PNM             // Image format .ppm and .pgm
    ...
    #include <raylib/external/stb_image.h>         // Required for: stbi_load_from_file()
    ...
    #include <raylib/external/stb_image_write.h>   // Required for: stbi_write_*()
#endif
    ...
    #include <raylib/external/stb_image_resize.h>  // Required for: stbir_resize_uint8() [ImageResize()]
#endif
