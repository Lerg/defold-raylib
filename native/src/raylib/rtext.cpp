...
#include <ctype.h>          // Requried for: toupper(), tolower() [Used in TextToUpper(), TextToLower()]
    ...
    #include <raylib/external/stb_rect_pack.h>     // Required for: ttf font rectangles packaging

    #define STBTT_STATIC
    #define STB_TRUETYPE_IMPLEMENTATION
    #include <raylib/external/stb_truetype.h>      // Required for: ttf font data reading
#endif
