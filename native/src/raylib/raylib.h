...
typedef enum {
	...
	SHADER_LOC_USE_MAP_NORMAL, // int
	SHADER_LOC_USE_MAP_METALLNESS // int
} ShaderLocationIndex;
...
RLAPI void LoadGLExtensions(void *loader);
...
RLAPI void DrawModelEx(Model model, Vector3 position, Quaternion rotation, Vector3 scale, Color tint); // Draw a model with extended parameters
RLAPI void DrawModelWires(Model model, Vector3 position, float scale, Color tint);                      // Draw a model wires (with texture if set)
RLAPI void DrawModelWiresEx(Model model, Vector3 position, Quaternion rotation, Vector3 scale, Color tint); // Draw a model wires (with texture if set) with extended parameters
