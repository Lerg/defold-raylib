...
// Default shader vertex attribute names to set location points
    ...
    #define RL_DEFAULT_SHADER_SAMPLER2D_NAME_TEXTURE2  "texture2"          // texture2 (texture slot active 2)
#endif
#ifndef RL_DEFAULT_SHADER_UNIFORM_NAME_USE_MAP_NORMAL
	#define RL_DEFAULT_SHADER_UNIFORM_NAME_USE_MAP_NORMAL  "useMapNormal"
#endif
#ifndef RL_DEFAULT_SHADER_UNIFORM_NAME_USE_MAP_METALNESS
	#define RL_DEFAULT_SHADER_UNIFORM_NAME_USE_MAP_METALNESS  "useMapMetalness"
#endif
...
void rlSetUniform(int locIndex, const void *value, int uniformType, int count)
{
	...
	if (count == 1) {
		switch (uniformType)
		{
			case RL_SHADER_UNIFORM_FLOAT: glUniform1f(locIndex, *(GLfloat*)value); break;
			case RL_SHADER_UNIFORM_VEC2: glUniform2f(locIndex, ((GLfloat *)value)[0], ((GLfloat *)value)[1]); break;
			case RL_SHADER_UNIFORM_VEC3: glUniform3f(locIndex, ((GLfloat *)value)[0], ((GLfloat *)value)[1], ((GLfloat *)value)[2]); break;
			case RL_SHADER_UNIFORM_VEC4: glUniform4f(locIndex, ((GLfloat *)value)[0], ((GLfloat *)value)[1], ((GLfloat *)value)[2], ((GLfloat *)value)[3]); break;
			case RL_SHADER_UNIFORM_INT: glUniform1i(locIndex, *(GLint *)value); break;
			case RL_SHADER_UNIFORM_IVEC2: glUniform2i(locIndex, ((GLint *)value)[0], ((GLint *)value)[1]); break;
			case RL_SHADER_UNIFORM_IVEC3: glUniform3i(locIndex, ((GLint *)value)[0], ((GLint *)value)[1], ((GLint *)value)[2]); break;
			case RL_SHADER_UNIFORM_IVEC4: glUniform4i(locIndex, ((GLint *)value)[0], ((GLint *)value)[1], ((GLint *)value)[2], ((GLint *)value)[3]); break;
			case RL_SHADER_UNIFORM_SAMPLER2D: glUniform1i(locIndex, *(GLint *)value); break;
